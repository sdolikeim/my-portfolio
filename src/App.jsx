    ...
    <div className="app">
      ...
      <main>
        <section className="section">
          <h2>About Me</h2>
          <p>
            Java/Spring Boot 기반으로 상품 조회, 상품 관리, 리뷰 검증, 북마크, 파일 업로드,
            페이지네이션 기능을 구현한 신입 백엔드 개발자입니다.
          </p>
          <p>
            기능 구현에서 끝나지 않고 사용자의 실제 이용 흐름, 예외 상황, 데이터 정합성을 함께
            고려하려고 합니다. 팀 프로젝트에서는 상품 도메인을 담당하며 관리자 상품 관리,
            이미지 업로드/삭제, 리뷰 중복 검증, 상품 상태에 따른 버튼 제어 기능을 구현했습니다.
          </p>
        </section>
        ...
        <section className="section">
          ...
          <div className="project-card">
            ...
            <p>
              ...
              상품 조회, 관리자 상품 관리, 이미지 업로드/삭제, 리뷰 검증, 북마크 기능을
              구현했습니다.
            </p>
        ...
        <section className="section">
          ...
          <div className="card">
            ...
            <p>
              Java, Spring Boot, React, Oracle 기반 웹 개발 과정 수료 예정입니다. REST API 설계,
              데이터베이스 연동, 프론트엔드 화면 구현, GitHub 협업을 경험했습니다.
            </p>
          </div>
        </section>
